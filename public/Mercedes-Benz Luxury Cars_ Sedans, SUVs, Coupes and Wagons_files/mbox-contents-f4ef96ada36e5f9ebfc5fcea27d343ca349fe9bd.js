...
if (typeof mboxVersion == 'undefined') {
  ...
  var mboxFactoryDefault = new mboxFactory('mercedezbenzusallc.tt.omtrdc.net', 'mercedezbenzusallc',
    'default');
};
...
if (mboxGetPageParameter("mboxDebug") != null ||
  ...
  document.write('<' + 'scr' + 'ipt language="Javascript1.2" src='
    + '"//admin10.testandtarget.omniture.com/admin/mbox/mbox_debug.jsp?mboxServerHost=mercedezbenzusallc.tt.omtrdc.net'
    + '&clientCode=mercedezbenzusallc"><' + '\/scr' + 'ipt>');
};
...
mboxVizTargetUrl = function(_mboxName /*, ... */) {
  ...
  _urlBuilder.setBasePath('/m2/' + 'mercedezbenzusallc' + '/viztarget');
...
/*mboxTrack() & mboxTrackLink & mboxTrackDefer v4 ==>Mbox.js Extra Javascript*/
